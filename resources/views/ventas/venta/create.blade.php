    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-4 col-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="serie_comprobante" value="0001" class="form-control"
                        ...
                        <div class="row">
                            <div class="col-sm-4 col-md-4 col-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control " data-style="btn-primary" name="pidarticulo" id="pidarticulo"
                            ...
                            <div class="col-sm-2 col-md-2 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="pdescuento" id="pdescuento" value="0" class="form-control"
                            ...
                            <div class="col-sm-2 col-md-2 col-12">
                                <div class="form-group">
                                    <button type="button" id="bt_add" class="btn btn-primary">Vender</button>
                                </div>
                ...
                <div class="form-group col-md-12 mt-2" id="guardar">
